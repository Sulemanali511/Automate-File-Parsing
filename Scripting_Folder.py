...
if answer == '1':
    ...
    folder_delete = input("If fou want directories deleted. Type in 'Yes'\n Else, type in any letter to continue: \n >> ")
    ...
    print(f'If you want to use this sript again you can find it in:\n {SOFTWARE_DEST}.\n')
    print(f'Good bye {user.capitalize()}')
else:
    print(f"Thank you for checking out my script!!. \n See you soon {user.capitalize()}")
